...
const shadow=n.shadow?`${n.shadow.x||0}px ${n.shadow.y||0}px ${n.shadow.blur||0}px ${n.shadow.color||'#00000033'}`:'none';v.style.textShadow=n.type==='text'?shadow:'none';v.style.boxShadow=n.type==='text'?'none':shadow;
if(n.modelAsset){
